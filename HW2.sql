...
0 - это значение числового типа данных, это число. Под это число
в памяти выделено место и есть ссылка на это место, которая может быть записана в какую либо переменную.

NULL - это специальное значение, которое означает, что поле пустое. Оно может быть записано в ячейку таблицы. 
При сравнении NULL с каким либо другим значением мы получим NULL.
*/